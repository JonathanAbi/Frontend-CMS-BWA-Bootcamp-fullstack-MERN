import {
  ...
  let debouncedFetchCategories = debounce(getData, 1000); // untuk menunda eksekusi fungsi hingga beberapa saat setelah pemanggilan terakhir. Menghindari spam hit ke API
