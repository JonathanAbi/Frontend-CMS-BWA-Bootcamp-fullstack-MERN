...
export const fetchTalents = () => { //function ini bisa dilakukan karena memakai redux-thunk yg membuat bisa menangani logika asinkron seperti memanggil API di dalam action creator
